...
from red_utils.ext.httpx_utils import (
    default_headers,
    constants,
    get_req_client,
    make_request,
...
example_schemas: Path = Path(f"{DATA_DIR}/example_schemas")
example_products: Path = Path(f"{example_schemas}/products/simplified_for_testing")
